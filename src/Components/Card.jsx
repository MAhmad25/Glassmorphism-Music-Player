...
const Card = () => {
      ...
      useGSAP(() => {
            if (playingMusicInfo.image) animateImage();
      }, [playingMusicInfo.image]);

      return (
            <div className="h-72 sm:h-64 lg:h-80 xl:left-[60%] lg:left-[55%] overflow-hidden shadow-zinc-800/30 shadow-2xl w-[80%] 2xl:w-[65%] absolute left-1/2 rounded-md -translate-y-1/2 -translate-x-1/2 top-1/2 sm:top-[54%] bg-white/30 dark:bg-transparent dark:backdrop-blur-lg">
